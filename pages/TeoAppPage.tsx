    ...
    if (!hasAccess) {
        return (
            <div className="text-center py-20 flex flex-col items-center">
                ...
                <Link to="/subscriptions" className="mt-8 inline-block bg-gradient-to-r from-brand-primary to-brand-secondary text-white font-semibold px-6 py-3 rounded-lg hover:opacity-90 transition-opacity">
