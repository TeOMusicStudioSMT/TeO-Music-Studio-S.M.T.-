  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        ...
        <Link to="/admin/news/new" className="bg-brand-primary px-4 py-2 rounded-lg font-semibold hover:opacity-90">
          Add New Article
        </Link>
      </div>
          ...
          {news.map((article, index) => (
            <div key={index} className="bg-brand-surface p-4 rounded-lg flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <Link to={`/admin/news/${index}/edit`} className="text-brand-primary hover:text-white">
                  Edit
                </Link>
