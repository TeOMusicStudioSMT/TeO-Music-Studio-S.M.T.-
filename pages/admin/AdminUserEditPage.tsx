...
const AdminUserEditPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (foundUser) {
        // Only update local state if it's not set or if we're editing a different user
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-white mb-8">Edit User: <span className="text-brand-primary">{user.name}</span></h1>
